                                    ...
                                    <CardItem style={styles.cardItem}>
                                        <Left>
                                            <Body>
                                                ...
                                                <Text style={styles.closeIcon}
                                                      onPress={() => this.toggleModal('RC')}><Icon name="close-circle"
                                    ...
                                    <CardItem style={styles.cardItem}>
                                        <Left>
                                            <Body>
                                                ...
                                                <Text style={styles.closeIcon} onPress={() => this.toggleModal('INVH')}><Icon
                                                    name="close-circle" style={{color: '#fff'}}/></Text>
                                            </Body>
                                        </Left>
                                    </CardItem>
                                    ...
                                    <CardItem style={styles.cardItem}>
                                        <Left>
                                            <Body>
                                                ...
                                                <Text style={styles.closeIcon} onPress={() => this.toggleModal('INDL')}><Icon
                                                    name="close-circle" style={{color: '#fff'}}/></Text>
                                            </Body>
                                        </Left>
                                    </CardItem>
                                    ...
                                    <CardItem style={styles.cardItem}>
                                        <Left>
                                            <Body>
                                                ...
                                                <Text style={styles.closeIcon}
                                                      onPress={() => this.toggleModal('POL')}><Icon name="close-circle"
                                                                                                    style={{color: '#fff'}}/></Text>
                                            </Body>
                                        </Left>
                                    </CardItem>
